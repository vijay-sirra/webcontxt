        ...
        <div className="row login-layout">
          <div className="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <div className="email-form">
                                    <span className="email-icon">
                                        <img src={emailIcon} className="inv-icon" />
                                    </span>
                                    <input placeholder="MARS EMAIL ID" id="usermail" name="email" variant="outlined" 
                                    defaultValue={formInput.name} className="textField" onChange={handleInput}
            ...
            <div className="bottom-vactor-img">
                <img className="vactor-img" src={vactorImage} />
            </div>
          </div>
        </div>
    </div>
